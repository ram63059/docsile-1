...
const ChatScreen = () => {
    return (
        <div className="bg-slate-100 flex items-center justify-center h-screen">
            <div className="bg-white flex flex-col rounded-lg max-w-md w-full h-full shadow-md">
                <ChatHeader user={{ name: 'Kageyama bro', lastActive: '2d ago' }} />
                <ChatMessages />
                <ChatInput onMessageSent={() => window.location.reload()} />
            </div>
        </div>
    );
};
