...
import doctordetailsinterests from "../assets/doctor-details-interests.svg";
import { useState } from "react";
import { useNavigate } from "react-router-dom";


function DoctorsProfile_interests() {
    ...
    function handleClick(){
      navigate('/doctor/doctor-profile-complete')
    }
  ...
  return (
    <div className="bg-slate-100 flex items-center justify-center h-screen">
        <div className="bg-white flex-col rounded-lg p-8 max-w-md w-full  h-screen">
          ...
          <div className="mt-8">
            <HeadAndSub
              head="Tell Us About Your Interests"
              sub="Share your background and select your interests to tailor your experience and connect with opportunities"
            />
          </div>

          <div className="mt-6">
            <div>
              <label htmlFor="interests" className="px-1 text-base font-semibold">Area Of Interests</label>
            </div>
            <div
              className={
                interests.length > 0
          ...
          <div className="mt-6 flex flex-col">
            <label htmlFor="label" className="px-1 text-base font-semibold">Social Media Links</label>
...
export default DoctorsProfile_interests