  ...
  >
    ...
    >
      {visibleCards.map((card, index) => (
        <div key={`${card.id}-${index}`} className="relative w-full h-[140px] flex-shrink-0 font-fontsm" >
          <div className="absolute border-2 border-gray-100 bg-white p-3 rounded-xl shadow-lg  w-[288px] h-[130px ] flex  items-center">
