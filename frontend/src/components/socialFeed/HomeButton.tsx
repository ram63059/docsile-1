...
const HomeButton: React.FC<HomeButtonProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50" style={{ background: 'rgba(0, 0, 0, 0.3)' }}>
      <div
        ref={popupRef}
        style={{
          position: 'fixed',
        ...
        className="bg-white bg-opacity-95 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden"
      >
        <div className="p-2">
