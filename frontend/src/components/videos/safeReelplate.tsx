    ...
    <div className="flex flex-col min-h-screen  overflow-y-hidden no-scrollbar  mx-auto"> 
      ...
      <div className="flex flex-1 min-h-screen lg:pl-24 max-w-7xl mx-auto w-full gap-10  ">
        ...
        <div className={`flex-1 flex  'max-w-[1000px]'    mx-auto transition-all duration-300`}>
          {/* Video Feed */}
          <div 
           className="relative   lg:max-h-[90vh] lg:max-w-[420px] font-fontsm transition-all duration-300 reels-container " 
           style={{
            height: "calc(100vh)",
          ...
          >
            {reelsData.map((reel, index) => (
              <div
                key={reel.id}
                className={`absolute w-full h-full rounded-3xl lg:w-[90%]   no-scrollbar  bg-black transition-transform duration-300 lg:pt-3 flex flex-row ${
                  index === currentReelIndex ? 'translate-y-0' : 
                  index < currentReelIndex ? '-translate-y-full' : 'translate-y-full'
                }`}
                style={{
              ...
              >
                ...
                <div className="relative h-full w-full     flex items-center justify-center">
                  ...
                  <button
                    onClick={toggleMute}
                    className="absolute top-0 left-3 p-2 bg-black bg-opacity-50 rounded-full text-white"
                  >
                  ...
                  {/* Progress Bar */}
                  <div 
                    className="absolute bottom-16 lg:bottom-3 rounded-b-3xl   left-0 right-0 h-1 bg-gray-800 cursor-pointer"
                    onClick={(e) => handleProgressClick(e, reel.id)}
                  >
                    <div 
                      className="h-full bg-white transition-all duration-100 z-20"
                  ...
                  <div className={`${
                    ...
                    'lg:absolute lg:-right-12 lg:-bottom-32 lg:-translate-y-1/2 lg:flex lg:flex-col lg:gap-6 ' +
